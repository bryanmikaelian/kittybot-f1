...
this.respond = function(room, command, callback){
  ...
  if (command === "/help") {
    ...
    callback("Meow. I support the following commands: /dismisskitty, /meow, /purr, /jingyi, /rimshots, /sifters, /sifter <number>, /crs, /cr <number>, /catnip <on,off>, /agonycat, /rangers, /important, /418, /starfox, /chuck");
  }
  // Meow
  if (command === "/meow") {
